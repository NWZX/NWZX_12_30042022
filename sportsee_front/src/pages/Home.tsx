            ...
            <AppContainer>
                ...
                >
                    <GridItem colSpan={9} w="100%" textAlign={'center'}>
                        <Grid templateColumns={['repeat(3, 1fr)']} gap={{ base: '16px', xl: '32px' }}>
                            <GridItem colSpan={3}>
                    ...
                    <GridItem colSpan={3} w="100%" textAlign={'center'}>
                        <Flex direction={'column'} h={'100%'} justifyContent="space-between">
                            <AppInfoCard
                                logo={<IconInfo1 w={{ base: '50px', xl: '60px' }} h={{ base: '50px', xl: '60px' }} />}
                                label="Calories"
                                unit="kCal"
                                value={user.main.keyData.calorieCount}
                            />
                            <AppInfoCard
                                logo={<IconInfo2 w={{ base: '50px', xl: '60px' }} h={{ base: '50px', xl: '60px' }} />}
                                label="Proteines"
                                unit="g"
                                value={user.main.keyData.proteinCount}
                            />
                            <AppInfoCard
                                logo={<IconInfo3 w={{ base: '50px', xl: '60px' }} h={{ base: '50px', xl: '60px' }} />}
                                label="Glucides"
                                unit="g"
                                value={user.main.keyData.carbohydrateCount}
                            />
                            <AppInfoCard
                                logo={<IconInfo4 w={{ base: '50px', xl: '60px' }} h={{ base: '50px', xl: '60px' }} />}
                                label="Lipides"
                                unit="g"
                                value={user.main.keyData.proteinCount}
                            />
